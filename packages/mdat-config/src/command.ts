...
export const commandDefinition: CommandDefinition = {
  commands: {
    ...
    init: {
      ...
      configPackageJson: {
        ...
        // A plain `@envsa/mdat-config` unfortunately does not resolve the export
        mdat: {
          $import: 'node_modules/@envsa/mdat-config/dist/index.js',
        },
      },
  ...
  description: "Envsa's Mdat shared configuration tools.",
  logColor: 'green',
