...
export type ConfigNames = 'envsa/disabled/dts' | 'envsa/disables/cjs' | 'envsa/disables/prettier' | 'envsa/html-script' | 'envsa/html/setup' | 'envsa/html' | 'envsa/ignores' | 'envsa/js/rules' | 'envsa/json/setup' | 'envsa/json/rules-json' | 'envsa/json/rules-jsonc' | 'envsa/json/rules-json5' | 'envsa/json/rules' | 'envsa/json/rules-settings' | 'envsa/json/rules-package' | 'envsa/json/rules-tsconfig' | 'envsa/json/rules-overrides' | 'envsa/markdown/remark' | 'envsa/markdown/code-blocks' | 'envsa/svelte/setup' | 'envsa/svelte/rules' | 'envsa/test/setup' | 'envsa/test/rules' | 'envsa/toml/setup' | 'envsa/toml/rules' | 'envsa/ts/rules' | 'envsa/yaml/setup' | 'envsa/yaml/rules'
