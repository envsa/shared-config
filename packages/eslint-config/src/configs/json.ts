...
export async function json(options: OptionsOverrides = {}): Promise<TypedFlatConfigItem[]> {
  ...
  return [
    ...
    },
    {
      ...
      name: 'envsa/json/rules-tsconfig',
      rules: {
        'json/no-comments': 'off',
        'json/sort-keys': [
          'error',
    ...
    {
      files: [GLOB_JSON, GLOB_JSONC, GLOB_JSON5],
      name: 'envsa/json/rules-overrides',
      rules: {
        ...overrides,
      },
    },
