...
export const commandDefinition: CommandDefinition = {
  commands: {
    ...
    init: {
      ...
      description: `Initialize configuration files for the entire suite of @envsa/shared-config tools. ${DESCRIPTION.multiOptionCaveat}`,
  ...
  description: 'Run aggregated @envsa/shared-config commands.',
  logColor: 'yellow',
  logPrefix: '🔬',
  name: 'envsa',
  order: 0,
