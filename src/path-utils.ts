...
/**
 * Returns list of package directories at or below the current working directory. Useful for monorepos. If not a monorepo, returns the closest package directory.
 * @example
 * Calling from `/Users/lrella/Code/shared-config` will yield:
 * ```ts
 * [
 ...
 * '/Users/lrella/Code/shared-config/packages/typescript-config',
 * ]
 * ```
 */
...
/**
 * Returns the root of the monorepo if you're in one, or the closest package directory if you're not in a monorepo.
 */
